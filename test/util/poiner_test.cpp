...
static_assert(is_smart_pointer_v<std::optional<int>>);
...
static_assert(std::is_same_v<remove_smart_pointer_t<std::unique_ptr<int>>, int>);
static_assert(std::is_same_v<remove_smart_pointer_t<std::unique_ptr<int const>>, int const>);
static_assert(std::is_same_v<remove_smart_pointer_t<int>, int>);
static_assert(std::is_same_v<remove_smart_pointer_t<int*>, int*>);
