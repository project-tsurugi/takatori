...
* default constructible
  * デフォルト構築したオブジェクトは、既定値、初期状態、無効値のいずれかを表す
<!--- 
既定値と初期状態の違いは？クラスがimmutable/mutableによる使い分けでしょうか？
--->
...
<!--- 
微妙な理由についてもう一言・・・。
lockやfileデスクリプタみたいな共有不可なリソースとshared_ptrのような共有可能なりソースと両方があるあたりでしょうか？
--->
    * 「コンテナ」はコンポーネントの特性を引き継ぐ
...
<!--- 
両方用意することの効果についてもう少し説明がほしいような。
2つに分けることで、copyかmoveの選択肢を考えさせて、注意喚起するという感じ？
--->
