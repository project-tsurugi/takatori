...
大規模オクテット列型分類 (*large octet string type category*)
~ 大規模オクテット列を表すデータ型の分類

  * `blob`
  * `unknown`

大規模文字列型分類 (*large character string type category*)
~ 大規模文字列を表すデータ型の分類
...
単項大規模オクテット列昇格 (*unary large octet string promotion*) は大規模オクテット列型分類の単項演算を行う際に、演算に適したデータ型に変換する。
...
二項大規模オクテット列昇格 (*binary large octet string promotion*) は特定の大規模オクテット列型分類の二項演算を行う際に、それぞれの大規模オクテット列を同じ種類のデータ型にそろえるための型変換である。
...
単項大規模文字列昇格 (*unary large character string promotion*) は大規模文字列型分類の単項演算を行う際に、演算に適したデータ型に変換する。
...
二項大規模文字列昇格 (*binary large character string promotion*) は特定の大規模文字列型分類の二項演算を行う際に、それぞれの大規模文字列を同じ種類のデータ型にそろえるための型変換である。
...
このとき、互換性上限とは、実行時における互換性のあるデータ型の集合のうち、各種昇格による上限のことを言う。
...
* `n = 1` のとき
  ...
  * `t{1}` が大規模オクテット列型分類の場合、 `t{1}` に単項大規模オクテット列昇格を適用した型を `t{1}'` とする
  * `t{1}` が大規模文字列型分類の場合、 `t{1}` に単項大規模文字列昇格を適用した型を `t{1}'` とする
...
* `n > 1` のとき, `t{i}` (`i = 2, .., n`) について:
  ...
  * `t{i-1}'`, `t{i}` がいずれも大規模オクテット列型分類の場合、 `t{i-1}'`, `t{i}` に二項大規模オクテット列昇格を適用した型を `t{i}'` とする
  * `t{i-1}'`, `t{i}` がいずれも大規模文字列型分類の場合、 `t{i-1}'`, `t{i}` に二項大規模文字列昇格を適用した型を `t{i}'` とする
...
| from \ to | `boolean` | `int1` | `int2` | `int4` | `int8` | `decimal` | `float4` | `float8` | `character` | `character varying` | `bit` | `bit varying` | `octet` | `octet varying` | `date` | `time_of_day` | `time_of_day_tz` | `time_point` | `time_point_tz` | `datetime_interval` | `blob` | `clob` | `array` | `record` |
|:-------------------:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
|           `boolean` | v | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - |
|              `int1` | - | v | v | v | v | D | v | v | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - |
|              `int2` | - | D | v | v | v | D | v | v | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - |
...
|             `array` | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | 1 | - |
|            `record` | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | 2 |
|           `unknown` | v | v | v | v | v | v | v | v | v | v | v | v | v | v | v | v | v | v | v | v | v | v | v | v |
...
|         `character` | D | D | D | D | D | D | D | D | v | v | D | D | D | D | D | D | D | D | D | D | D | D | D | D |
| `character varying` | D | D | D | D | D | D | D | D | v | v | D | D | D | D | D | D | D | D | D | D | D | D | D | D |
|               `bit` | - | - | - | - | - | - | - | - | v | v | v | - | - | - | - | - | - | - | - | - | - | - | - | - |
|       `bit varying` | - | - | - | - | - | - | - | - | v | v | - | v | - | - | - | - | - | - | - | - | - | - | - | - |
|             `octet` | - | - | - | - | - | - | - | - | v | v | - | - | v | v | - | - | - | - | - | - | v | - | - | - |
|     `octet varying` | - | - | - | - | - | - | - | - | v | v | - | - | v | v | - | - | - | - | - | - | v | - | - | - |
|              `date` | - | - | - | - | - | - | - | - | v | v | - | - | - | - | v | - | - | v | v | - | - | - | - | - |
|       `time_of_day` | - | - | - | - | - | - | - | - | v | v | - | - | - | - | - | v | v | v | v | - | - | - | - | - |
|   `time_of_day_tz`  | - | - | - | - | - | - | - | - | v | v | - | - | - | - | - | v | v | v | v | - | - | - | - | - |
|        `time_point` | - | - | - | - | - | - | - | - | v | v | - | - | - | - | v | v | v | v | v | - | - | - | - | - |
|     `time_point_tz` | - | - | - | - | - | - | - | - | v | v | - | - | - | - | v | v | v | v | v | - | - | - | - | - |
...
| from \ to | `boolean` | `int4` | `int8` | `decimal` | `float4` | `float8` | `character varying` | `bit varying` | `octet varying` | `date` | `time_of_day` | `time_of_day_tz` | `time_point` | `time_point_tz` | `blob` | `clob` | `unknown` |
|--------------------:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
|           `boolean` | v | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - |
|              `int4` | - | v | v | v | v | v | - | - | - | - | - | - | - | - | - | - | - |
|              `int8` | - | - | v | v | v | v | - | - | - | - | - | - | - | - | - | - | - |
...
|              `blob` | - | - | - | - | - | - | - | - | - | - | - | - | - | - | v | - | - |
|              `clob` | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | v | - |
|           `unknown` | v | v | v | v | v | v | v | v | v | v | v | v | v | v | v | v | v |
...
~ 比較演算
  ...
  * 事前条件
    * `left`, `right` が下記の型変換を行える組み合わせであること
    * `compare_kind` に指定した比較演算子が、下記の型変換後の型に適用可能
  * パラメーター
...
比較可能性 (*comparable*) とは、あるデータ型において、その値同士を比較することができることを指す。
それぞれのデータ型には、等価比較可能性 (*equality comparable*) と順序比較可能性 (*order comparable*) が以下のように定義されている。

|  データ型 | 等価比較可能性 | 順序比較可能性 |
|--------------------:|:-:|:-:|
|           `boolean` | v | v |
|              `int1` | v | v |
|              `int2` | v | v |
...
等価比較可能性を要求する操作は以下のとおりである:

* 以下の `compare_kind` を利用する比較操作
  * `equal`
  * `not_equal`
* グループ化

順序比較可能性を要求する操作は以下のとおりである:
...
なお、いずれの比較においても、すべてのデータは同じデータ型に属していなければならない。
多くの場合、データ型をそろえるために事前に [単一化変換](#単一化変換) が行われる。

----
note:

* 表のように、順序比較可能であれば等価比較もまた可能となっている
  * これは、最適化のための拡張可能性としてそのように定義している
