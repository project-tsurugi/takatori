 ...
 * If the target type - Template<Args...> is valid, then this struct inherits from std::true,
 ...
 * If it is not a valid type, this becomes meta-type of Default.
...
/**
 * @brief provides Template<Args...> only if it is a valid type
 * If it is not a valid type, this becomes meta-type of not_detected.
 * @tparam Template type template to be validated
 * @tparam Args the template arguments to be validated
 */
template<template<class...> class Template, class... Args>
