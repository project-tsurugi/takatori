...
#include "broken_input_exception.h"
 ...
 * @param iterator the buffer content iterator
 ...
 */
entry_type read_type(util::buffer_view::const_iterator iterator, util::buffer_view::const_iterator end) noexcept;
 ...
 * @see read_type()
 */
void read_end_of_contents(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);
 ...
 * @see read_type()
 */
void read_null(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);
 ...
 * @throws std::runtime_error if the entry is not expected type
 * @throws broken_input_exception if the encoded value is not valid
 * @see read_type()
 */
std::int64_t read_int(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);

/**
 * @brief retrieves `float4` entry on the current position.
 * @details This operation will advance the buffer iterator to the next entry, only if it is successfully completed.
 * @param iterator the buffer content iterator
 * @param end the buffer ending position
 * @return the retrieved value
 ...
 * @see read_type()
 */
float read_float4(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);
 ...
 * @see read_type()
 */
double read_float8(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);
 ...
 * @see read_type()
 */
::fpdecimal::Decimal read_decimal(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);
 ...
 * @see read_type()
 */
std::string_view read_character(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);
 ...
 * @see read_type()
 */
std::string_view read_octet(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);
 ...
 * @see read_type()
 */
util::bitset_view read_bit(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);
 ...
 * @see read_type()
 */
datetime::date read_date(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);
 ...
 * @see read_type()
 */
datetime::time_of_day read_time_of_day(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);
 ...
 * @see read_type()
 */
datetime::time_of_day read_time_point(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);
 ...
 * @see read_type()
 */
datetime::time_of_day read_datetime_interval(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);
 ...
 * @see read_type()
 */
std::size_t read_array_begin(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);
 ...
 * @see read_type()
 */
std::size_t read_row_begin(util::buffer_view::const_iterator& iterator, util::buffer_view::const_iterator end);
