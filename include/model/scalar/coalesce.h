...
#include "model/tree_element_vector.h"
...
public:
     ...
     */
    tree_element_vector<expression>& alternatives() noexcept;

    /// @copydoc alternatives()
    tree_element_vector<expression> const& alternatives() const noexcept;
...
private:
    tree_element_vector<expression> alternatives_;
    parent_type* parent_ {};
};
