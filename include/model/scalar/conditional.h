...
public:
     ...
     */
    tree_fragment_vector<alternative>& alternatives() noexcept;
    
    /// @copydoc alternatives()
    tree_fragment_vector<alternative> const& alternatives() const noexcept;
...
private:
    tree_fragment_vector<alternative> alternatives_;
