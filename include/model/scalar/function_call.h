...
public:
     ...
     */
    tree_element_vector<expression>& arguments() noexcept;

    /// @copydoc arguments()
    tree_element_vector<expression> const& arguments() const noexcept;
...
private:
    ...
    tree_element_vector<expression> arguments_;
    parent_type* parent_ {};
};
