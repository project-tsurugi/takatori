...
public:
     ...
     */
    tree_fragment_vector<declarator>& variables() noexcept;
    
    /// @copydoc variables()
    tree_fragment_vector<declarator> const& variables() const noexcept;
...
private:
    tree_fragment_vector<declarator> variables_;
